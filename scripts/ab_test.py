...
def degree_of_certainty_draws(base_rate, treatment_rate, num_participants=None,
                              num_control=None, num_treatment=None, num_draws=1000):
  """
  ...
  if num_participants:
    ...
    if not (num_base and num_treatment):
      raise ValueError("If you provide num_control or num_treatment you must provide the other")
